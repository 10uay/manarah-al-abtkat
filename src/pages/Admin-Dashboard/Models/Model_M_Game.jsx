...
export default function Model_M_Game({
  data,
  setData,
  setTranslation_M_Game_EN,
  setTranslation_M_Game_AR,
  setTranslation_M_Game_DE,
}) {
  ...
  useEffect(() => {
    const sanitizedTranslationEN = sanitizeTranslations({
      [data.M_Game.title]: translateTitleInEN,
      [data.M_Game.para]: translateParaInEN,
    });

    const sanitizedTranslationAR = sanitizeTranslations({
      [data.M_Game.title]: translateTitleInAR,
      [data.M_Game.para]: translateParaInAR,
    });

    const sanitizedTranslationDE = sanitizeTranslations({
      [data.M_Game.title]: translateTitleInDE,
      [data.M_Game.para]: translateParaInDE,
    });

    setTranslation_M_Game_EN(sanitizedTranslationEN);
    setTranslation_M_Game_AR(sanitizedTranslationAR);
    setTranslation_M_Game_DE(sanitizedTranslationDE);
  }, [data.M_Game]);
    ...
    uploadTask.on(
      ...
      (error) => {
        if (error) {
          ...
          console.log("error uploading img in Game section");
        }
      },
      () => {
        setUploadingImg(false);
    ...
    <>
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        ...
        <Modal.Body className="px-3">
          <img src="/images/M_Game.png" alt="m intro four img" />
          <hr />
          <div className="space-y-6 mt-5">
            ...
            <div className="flex lg:flex-row flex-col gap-5 flex-wrap items-center">
              <div className="w-full lg:w-72">
                <div className="mb-2 block w-full">
                  <Label
                    htmlFor="title-of-M-Game"
                    value="title-of-M-Game"
                    style={{
                      fontSize: "16px",
                    }}
                  />
            ...
            <div className="flex lg:flex-row flex-col gap-5 flex-wrap items-center">
              <div className="w-full lg:w-72">
                <div className="mb-2 block w-full">
                  <Label
                    htmlFor="para-of-M-Game"
                    value="para-of-M-Game"
                    style={{
                      fontSize: "16px",
                    }}
                  />
