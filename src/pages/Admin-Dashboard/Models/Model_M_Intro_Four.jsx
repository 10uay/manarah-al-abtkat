...
export default function Model_M_Intro_Four({
  data,
  setData,
  ...
  useEffect(() => {
    const sanitizedTranslationEN = sanitizeTranslations({
      [data.M_Intro_Four.title]: translateTitleInEN,
      [data.M_Intro_Four.para]: translateParaInEN,
    });

    const sanitizedTranslationAR = sanitizeTranslations({
      [data.M_Intro_Four.title]: translateTitleInAR,
      [data.M_Intro_Four.para]: translateParaInAR,
    });

    const sanitizedTranslationDE = sanitizeTranslations({
      [data.M_Intro_Four.title]: translateTitleInDE,
      [data.M_Intro_Four.para]: translateParaInDE,
    });

    setTranslation_M_Intro_Four_EN(sanitizedTranslationEN);
    setTranslation_M_Intro_Four_AR(sanitizedTranslationAR);
    setTranslation_M_Intro_Four_DE(sanitizedTranslationDE);
    ...
    <>
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        ...
        <Modal.Body className="px-3">
          <img src="/images/M_Intro_Four.png" alt="m intro four img" />
          <hr />
          <div className="space-y-6 mt-5">
            ...
            <div className="flex lg:flex-row flex-col gap-5 flex-wrap items-center">
              <div className="w-full lg:w-72">
                <div className="mb-2 block w-full">
                  <Label
                    htmlFor="title-of-intro-four"
                    value="title-of-intro-four"
                    style={{
                      fontSize: "16px",
                    }}
                  />
            ...
            <div className="flex lg:flex-row flex-col gap-5 flex-wrap items-center">
              <div className="w-full lg:w-72">
                <div className="mb-2 block w-full">
                  <Label
                    htmlFor="para-of-intro-four"
                    value="para-of-intro-four"
                    style={{
                      fontSize: "16px",
                    }}
                  />
            ...
            <div className="flex w-fit items-center justify-center">
              ...
              <Label
                htmlFor="dropzone-file-intro-four"
              ...
              <div className="relative w-40 h-40 mx-auto p-5">
                ...
                {data.M_Intro_Four.img && (
                  <img
                    src={data.M_Intro_Four.img}
                    alt="dropzone-file-intro-four"
