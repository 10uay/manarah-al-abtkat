...
export default function Model_M_Intro_One({
  data,
  setData,
  domain,
  setTranslation_M_Intro_One_EN,
  setTranslation_M_Intro_One_AR,
  setTranslation_M_Intro_One_DE,
}) {
  ...
  useEffect(() => {
    const sanitizedTranslationEN = sanitizeTranslations({
      [data.M_Intro_One.title]: translateTitleInEN,
      [data.M_Intro_One.para]: translateParaInEN,
    });

    const sanitizedTranslationAR = sanitizeTranslations({
      [data.M_Intro_One.title]: translateTitleInAR,
      [data.M_Intro_One.para]: translateParaInAR,
    });

    const sanitizedTranslationDE = sanitizeTranslations({
      [data.M_Intro_One.title]: translateTitleInDE,
      [data.M_Intro_One.para]: translateParaInDE,
    });

    setTranslation_M_Intro_One_EN(sanitizedTranslationEN);
    setTranslation_M_Intro_One_AR(sanitizedTranslationAR);
    setTranslation_M_Intro_One_DE(sanitizedTranslationDE);
    ...
    uploadTask.on(
      ...
      (error) => {
        if (error) {
          ...
          console.log("error uploading img in Intro One");
        }
      },
      () => {
        setUploadingImg(false);
    ...
    <>
      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        ...
        <Modal.Body className="px-3">
          <img src="/images/M_Intro_One.png" alt="m intro one img" />
          <hr />
          <div className="space-y-6 mt-5">
            ...
            <div className="flex lg:flex-row flex-col gap-5 flex-wrap items-center">
              <div className="w-full lg:w-72">
                <div className="mb-2 block w-full">
                  <Label
                    htmlFor="title-of-intro-one"
                    value="title-of-intro-one"
                    style={{
                      fontSize: "16px",
                    }}
                  />
            ...
            <div className="flex lg:flex-row flex-col gap-5 flex-wrap items-center">
              <div className="w-full lg:w-72">
                <div className="mb-2 block w-full">
                  <Label
                    htmlFor="para-of-intro-one"
                    value="para-of-intro-one"
                    style={{
                      fontSize: "16px",
                    }}
                  />
            ...
            <div className="flex w-fit items-center justify-center">
              ...
              <Label
                htmlFor="dropzone-file-intro-one"
              ...
              <div className="relative w-40 h-40 mx-auto p-5">
                ...
                {data.M_Intro_One.img && (
                  <img
                    src={data.M_Intro_One.img}
                    alt="dropzone-file-intro-one"
